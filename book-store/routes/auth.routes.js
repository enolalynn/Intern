...
authRouter.post(
  ...
  [
    ...
    body("name")
      ...
      .withMessage("Name must be between 6 and 20 long"),
    body("password")
      .isString()
      .isLength({ min: 6, max: 20 })
      .withMessage("Password must be between 6 and 20 long"),
  ],
  registerUser
);
...
authRouter.post(
  ...
  [
    ...
    body("name")
      ...
      .withMessage("Name must be between 6 and 20 character long"),
    body("password")
      .isString()
      .isLength({ min: 6, max: 20 })
